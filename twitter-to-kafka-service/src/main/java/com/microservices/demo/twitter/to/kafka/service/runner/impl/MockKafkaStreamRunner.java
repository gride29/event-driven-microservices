...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private String getFormattedTweet(String[] keywords, int minTweetLength, int maxTweetLength) {
        String[] params = new String[] {
            ZonedDateTime.now().format(DateTimeFormatter.ofPattern(TWITTER_STATUS_DATE_FORMAT, Locale.ENGLISH)), // random created_at
                String.valueOf(ThreadLocalRandom.current().nextLong(Long.MAX_VALUE)), // random id
                getRandomTweetContent(keywords, minTweetLength, maxTweetLength), // random text
                String.valueOf(ThreadLocalRandom.current().nextLong(Long.MAX_VALUE)) // random user
        };
